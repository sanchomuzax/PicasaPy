...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.5.4-orange.svg" alt="Version 0.5.4">
...
⚠️ **Korai fejlesztési fázisban** van (verzió: `0.5.4`), messze az 1.0-tól. A projekt túl van az 1. fázis (kezelő + néző) MVP-jén, és mélyen a **2. fázisban** (nem-destruktív szerkesztő) jár. A formátum-kompatibilitás és az alapvető könyvtárkezelés stabil, de az API és a fájlformátum-részletek még változhatnak.
