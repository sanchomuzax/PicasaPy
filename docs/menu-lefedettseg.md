...
|---|---:|---|
| ✅ **viselkedés feltárva** | 66 | a `picasa-menu-parancsok-viselkedes.md`-on: mit indít, mit ír, mikor |
| 🟡 érdemi lapon szerepel | 73 | valamit tudunk róla, de a viselkedése nincs végigvive |
| ⚠️ **csak a neve** | 1 | egyedül a leltárban — a felirata és a helye |
| ⛔ **sehol** | 0 | egyetlen spec sem említi |
| — hatókörön kívül | 14 | megszűnt szolgáltatás vagy nem a mi dolgunk |
