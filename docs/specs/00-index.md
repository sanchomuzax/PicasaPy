...
| [kollazs-panel-ui-spec.md](kollazs-panel-ui-spec.md) | **A Kollázs-panel MEGVALÓSÍTÁSI UI-specifikációja** — elemfa, `objectName`-ek, a `.tre` kényszereiből levezetett méretezési törvény, R2/R3 szerkezeti kontroll (a Beállítások-lap wrapper- és clip-réteg eltéréseivel), vezérlő-API, teszt-szerződés, jegyekre bontás |
