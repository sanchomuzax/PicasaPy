...
### [picasa-create-features.md](picasa-create-features.md) — 1 NYITOTT tétel (a #1412: **ki írja a csomópont `+0x2c` mezőjét (`scale`)?** 2026-09-07, 177. kör: a kollázs-sáv `0x00829000`–`0x00895000` **878 függvénye** dekompilátor-szinten végigpásztázva — egyik sem ír számolt `scale`-t; a mentési ág csak OLVAS, az interaktív képhozzáadás fája nem is érinti ⇒ **az író a sávon KÍVÜL van**. A megnevezett következő vágás: a panel parancs-elosztója `0x0082d570` 3 szint mélyen, majd a téma-osztályok metódusai; `kollazs-eletciklus.md` 26.4–26.5)
