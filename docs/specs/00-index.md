...
### [picasa-ini-format.md](picasa-ini-format.md) — 1 BLOKKOLT tétel (a `[encoding]` fejléc, #2452) + 1 nyitott (a `text=` 8. mezőjének FELSŐ 16 BITJE, #2108; a mező két alsó része 2026-09-05-én LEZÁRULT)
