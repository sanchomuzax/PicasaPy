...
### [picasa-create-features.md](picasa-create-features.md) — 1 NYITOTT tétel (a #1412: **ki írja a csomópont `+0x2c` mezőjét (`scale`)?** 2026-09-07, 178. kör ÖNHELYESBÍTÉS: a 177. kör pásztázója VAK volt az index-alakra (`param_1[0xb]`), ezért a „nincs író a sávban" negatív MEGDŐLT — a javított, pozitív kontrollal ellenőrzött futás **37 INDEX-alakú** írást is talál. A következő lépés a 37 találat BÁZISÁNAK tisztázása; `kollazs-eletciklus.md` 27.)
