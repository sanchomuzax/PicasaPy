...
### [picasa-create-features.md](picasa-create-features.md) — 1 NYITOTT tétel (a #1412: **ki tölti fel a dokumentum `[+0x48]` csomópont-tömbjét, és a `+0x2c`-t (`scale`) ott honnan veszi?** 2026-09-07, 179. kör: kiderült, hogy az elrendező egy IDEIGLENES, a hívóban elpusztított vektorba ír — a mentés más tömböt olvas —, tehát az öt körön át keresett „felülíró" nem is létezik. A következő lépés a dokumentum-tömb feltöltőjének azonosítása; `kollazs-eletciklus.md` 28.)
