...
| [ui-audit-mainwindow.md](ui-audit-mainwindow.md) | Főablak: mappafa, eszköztár, tálca, görgetősáv · ⭐ **2026-09-22 (#656/R6):** a `thumbui` hat rejtett eleménél elválasztva a deklarált geometria, a kezdeti láthatóság és az élő parancsút; a `fullview` `hiddentimer`-feloldása blokkolt |
