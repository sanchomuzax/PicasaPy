...
⭐ **2026-09-18 — a #2476 pontmaszk-leletének független helyi kontrollja:** a `Picasa3.exe` SHA-256-a `644b7bec89a2e4d57d119d15aa36af1df12a4c3547b692bc0462af35a93ddc96`; a `TiledImageMask` attribútum-olvasója (`0x00bba2e0`) és rajzolója (`0x00bbaa90`) visszaadja a `scaleWidth`/`scaleHeight` = **0,8**, a négy `padding` = **0**, az `alphaMin`/`alphaMax` = **0,0/1,0** értéket, valamint a `0x00`→`0xFF`, kétmegállós lineáris radiális rámpát. A bináris kérdés lezárult; a terméki átvezetés marad a #2476 nyitott fejlesztési teendője. Részletek: `filterdesc-registry.md` **Független helyi ellenőrzés**.
