...
### [picasa-create-features.md](picasa-create-features.md) — 1 NYITOTT tétel (a #1412; 2026-09-06: a tulajdonos mérése MEGCÁFOLTA a „nincs számoló kód” negatívot — AI27/AI28/AI29-ben a `scale` 500/256/158, tehát VAN számoló írási út; `kollazs-eletciklus.md` 17.15 önhelyesbítés ⇒ a jegy újra `ready`, gépi munka)
