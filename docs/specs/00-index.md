...
| [lanc-szakadasok-leltar.md](lanc-szakadasok-leltar.md) | **Ahol a háttér kész, de a felület nem éri el** — mért leltár: 19 regisztrált vezérlőből egy sem holt, de **52 tag** elérhetetlen a QML-ből, ebből **39-et csak a teszt hív**. Négy megerősített lelet (Nyomtatás · arckeresés-indítás · e-mail küldés · visszavonás-gombok) és a naiv `.tagnév` keresés csapdája (négy név két gazdával). Jegyek: **#1472**–**#1476** |
