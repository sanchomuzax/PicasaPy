...
### [picasa-create-features.md](picasa-create-features.md) — 1 BLOKKOLT tétel (a #1412; 2026-09-06: a GÉPI keresés KIMERÜLT — a `Picasa3.exe`-ben nincs a `scale`-t számoló kód, `kollazs-eletciklus.md` 17.15; a döntéshez egy ÚJ kollázs `.cxf`-je kell a tulajdonos gépéről ⇒ `felhasználóra-vár`)
