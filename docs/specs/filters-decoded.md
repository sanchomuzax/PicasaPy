...
| **MEGFEJTVE A FILTERDESC-BŐL ÉS VÉGIGMÉRVE (#884, #3631)** | a művelet a #878-ban megfejtett, FÉNYESSÉG-TARTÓ `TintImageOperation` (a `Neon` záró lépésével közös): a bemenet Haeberli lumáját (NEM Rec.601, #3631) bájtra megőrzi, egy 256 elemű, szín szerint épített táblával. A korábbi modell tömör színréteget kevert a képre, tehát `Fade = 0`-nál egyszínű felületet adott (ΔE 33,45 / SSIM 0,63); a #884 golden-illesztése ezt **ΔE 1,50 / SSIM 0,9991**-re javította Rec.601-súlyokkal, a #3631 pedig a natív Haeberli-táblára — utóbbi a golden szinten belül marad, de telített kéknél/sárgánál akár 71 szinttel közelebb az eredetihez. Ecset-eszköz híján továbbra is a TELJES KÉPRE fut, amit a #685 exportja igazol | `PicnikTint` |
...
#### ⚠️ A BEÉPÍTÉS mérés-köteles — és egy korábbi mérés ÓVATOSSÁGRA int

A mag minden bemenete kiolvasott szám, tehát megvalósítható. ⛔ **De az alábbi
mérés (ugyanezen a lapon) ellene szól:** a „háromléptékű `[1,2,1]` dilatált
lánc (`n = 1, 2, 4`)" az eredeti exporton **2,03** eltérést adott, miközben a
mért Gauss (σ = 4,00) **0,552**-t. Ez a próba viszont **nem** a most
kiolvasott magot futtatta: `[1,2,1]` súlyokkal, **fal-térkép nélkül** ment.
...
szándéka (a beépítéshez nem kell) és maga a BEÉPÍTÉS mérése.*
