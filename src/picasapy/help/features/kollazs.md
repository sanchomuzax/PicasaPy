...
A kollázs több képből egyetlen új képet állít össze.

## Indítás

Jelöld ki a képeket, majd:

- **Létrehozás ▸ Képkollázs…**, vagy
- a képtálca **Kollázs** gombja.

Ha nincs kijelölés, a program szól: előbb jelölj ki képeket a
könyvtárban, vagy tedd őket a képtálcára.

A kollázs saját lapon nyílik meg, a szerkesztő bal oldali paneljével.

## Kollázs-típusok

A **Kollázs típusa** választóban:

| típus | mit ad |
|---|---|
| **Képkupac** | szétszórt képek egymáson |
| **Mozaik** | a képek kitöltik a lapot |
| **Képkockamozaik** | mozaik, kiemelt középső képpel |
| **Rács** | szabályos sorok és oszlopok |
| **Indexkép** | bélyegképek, fejléccel |
| **Többszörös exponálás** | a képek egymásra vetítve |

## Beállítások

A **Beállítások** fülön:

- **Oldalformátum** — a kollázs mérete és aránya: aktuális képernyő,
  szabvány képernyő, széles monitor, teljes oldal, A4, levélpapír,
...
- **Kép használata** — a kijelölt képet teszi háttérnek (**A kijelölt
  elemek használata**), vagy a kép helyi menüjének **Beállítás
  háttérként** parancsával.
...
A **Klipek** fülön látod, mely képekből épül a kollázs. Innen tudsz
képeket **hozzáadni** (+) és **elvenni** (–), illetve a **Továbbiak…**
gombbal újabb adagot behozni a könyvtárból.

## Elkészítés és mentés
...
felajánlja a **Piszkozat visszaállítása** lehetőséget, vagy a
**Piszkozat elvetése** gombot.

A **Visszaállítás** gomb az összes változtatást visszavonja a kollázson.
A lap bezárásakor a program megkérdezi, hogy **Piszkozat mentése** vagy
