...
class TestAMenupont:
    ...
    def test_az_EREDETI_feliratot_hasznalja(self):
        ...
        assert 'qsTr("Clear Geotags")' in blokk_horgonyra(
            _MENU, 'objectName: "menuToolsClearGeotag"'
        )
    ...
    def test_a_menupont_NEM_nema(self):
        ...
        assert "clearGeotagRequested()" in blokk_horgonyra(
            _MENU, 'objectName: "menuToolsClearGeotag"'
        )
...
class TestAMegerosites:
    ...
    def test_a_torles_CSAK_a_megerosites_utan_fut(self):
        ...
        ez bukik."""
        blokk = blokk_horgonyra(_MAIN, 'objectName: "clearGeotagConfirm"')
...
class TestAHelyekPanelGombja:
    def test_a_felirat_a_DARABSZAMOT_is_kiirja(self):
        ...
        blokk = blokk_horgonyra(_PLACES, 'objectName: "placesClearButton"')
